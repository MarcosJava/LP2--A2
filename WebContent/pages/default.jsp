   ...
   <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../index.html">SBV -- Sistema Boa Venda</a>
            </div>
            <!-- /.navbar-header -->
            <!-- /.navbar-top-links -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.html"><i class="fa fa-dashboard fa-fw"></i>Cliente</a>
                        </li>
                        <li>
                            <a href="index.html"><i class="fa fa-dashboard fa-fw"></i>Produtos</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        <div id="page-wrapper">
            ...
            <!-- /.row -->
                ...
                <div class="alert alert-success">
                    Seja Bem-Vindo ao SBV, onde vc compra e fica feliz =D.<br> Sistema Boas Vendas
                </div>
            </div>
            <!-- /.row -->
        </div>
